  ...
  return (
    <div className="home-page">
      <style>{`
        ...
        .explore-section { padding: 60px 20px; text-align: center; background: #d3d3d3; }
        .explore-section h2 { color: #333; font-size: 40px; font-weight: bold;}
      ...
      <section className="hero" >
        ...
        <div className="event-categories">
          <Link to="/studentdashboard"><button className="category-btn">Home</button></Link>
                   ...
                   {ClassicCollection.map(bo => (
                     <div key={bo.id} className="book-card-2">
                       ...
                       <div className="book-details-2">
                         ...
                         <p><b>Author:</b> {bo.author}</p>
                         <p><b>Category:</b> {bo.category}</p>
                         <button className="book-btn-2" onClick={() => navigate("/reserve", { state: { book: bo } })}>Reserve</button>
                       </div>
                     </div>
                   ))}
                 </div>

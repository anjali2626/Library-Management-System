 ...
 const NewCollection = [
  ...
  return (
    <div className="home-page">
      ...
      <br /><br />
           <h3 className="mt-4" style={{fontSize: "35px", marginLeft:"10rem", fontWeight: "bold", color:"#620909",}}>Newly Added Books List</h3>
           <br />
           <table className="table"style={{marginLeft:"10rem", width: "1100px", marginTop: "2rem",}}>
             <thead><tr><th style={{fontSize: "30px",}}>Name</th><th style={{fontSize: "30px",}}>Author</th></tr></thead>
             <tbody>
               {books.map(b=>(
                 <tr key={b.id}>
                  
                  <td style={{fontSize: "20px", marginTop: "1rem",}}>{b.name}</td>
                  <td style={{fontSize: "20px", marginTop: "1rem",}}>{b.author}</td>
          ...
          {ClassicCollection.map(bo => (
            <div key={bo.id} className="book-card-2">
              ...
              <div className="book-details-2">
                ...
                <p><b>Author:</b> {bo.author}</p>
                <p><b>Category:</b> {bo.category}</p>
                <Link to="/login"><button className="book-btn-2" onClick={() => navigate("/login")}>Reserve</button></Link>  
              </div>
            </div>
          ))}
        </div>
